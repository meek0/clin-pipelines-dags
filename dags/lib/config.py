...
if env == Env.QA:
    ...
    spark_jar = 's3a://cqgc-qa-app-datalake/jars/clin-variant-etl-v2.10.0.jar'
    ...
    panels_image = 'ferlabcrsj/clin-panels:13b8182d493658f2c6e0583bc275ba26967667ab-1683653903'
    es_url = 'http://elasticsearch:9200'
    spark_jar = 's3a://cqgc-staging-app-datalake/jars/clin-variant-etl-v2.9.4.jar'
    ca_certificates = 'ingress-ca-certificate'
    minio_certificate = 'minio-ca-certificate'
    indexer_context = K8sContext.DEFAULT
elif env == Env.PROD:
    ...
    spark_jar = 's3a://cqgc-prod-app-datalake/jars/clin-variant-etl-v2.9.4.jar'
