...
def qc(
    ...
    with TaskGroup(group_id=group_id) as group:
        ...
        vcf_snv >> vcf_nor_variants >> no_null_variant_centric >> no_null_gene_centric >> [filters_snv, filters_frequency_extra, filters_frequency_missed, no_null_cnv_centric, only_null_gene_centric, only_null_cnv_centric, same_value_gene_centric, same_value_cnv_centric, dictionary_cnv, dictionary_consequences, dictionary_donors, dictionary_snv, freq_rqdm_total, freq_rqdm_affected, freq_rqdm_non_affected, freq_by_analysis_total, freq_by_analysis_affected, freq_by_analysis_non_affected] >> same_value_variant_centric >> only_null_variant_centric
