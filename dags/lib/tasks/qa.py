from lib.config import K8sContext, env_url, Env
from lib.doc import qa as doc
from lib.operators.spark import SparkOperator


def non_empty_tables(release_id: str, spark_jar: str) -> SparkOperator:
...
def no_dup_gnomad(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_nor_snv(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_nor_snv_somatic(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_nor_consequences(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_nor_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_snv(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
        task_id='no_dup_snv',
...
def no_dup_snv_somatic(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_consequences(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_variant_centric(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_cnv_centric(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def no_dup_varsome(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def same_list_nor_snv_nor_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def same_list_nor_snv_somatic_nor_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def same_list_snv_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def same_list_snv_somatic_variants(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
...
def same_list_variants_variant_centric(release_id: str, spark_jar: str) -> SparkOperator:
    return SparkOperator(
